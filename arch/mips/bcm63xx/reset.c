...
#define BCM6328_RESET_PCIE	\
	(SOFTRESET_6328_PCIE_MASK | SOFTRESET_6328_PCIE_CORE_MASK | \
...
#define BCM6358_RESET_SPI	0 /* SOFTRESET_6358_SPI_MASK */
#define BCM6358_RESET_ENET	0 /* SOFTRESET_6358_ENET_MASK */
#define BCM6358_RESET_USBH	0 /* SOFTRESET_6358_USBH_MASK */
#define BCM6358_RESET_USBD	0
#define BCM6358_RESET_DSL	0 /* SOFTRESET_6358_ADSL_MASK */
#define BCM6358_RESET_SAR	0 /* SOFTRESET_6358_SAR_MASK */
#define BCM6358_RESET_EPHY	0
#define BCM6358_RESET_ENETSW	0
#define BCM6358_RESET_PCM	0 /* SOFTRESET_6358_PCM_MASK */
#define BCM6358_RESET_MPI	0 /* SOFTRESET_6358_MPI_MASK */
...
static int __init bcm63xx_reset_bits_init(void)
{
	if (BCMCPU_IS_6328()) {
		...
		reset_reg = 0x34; /* PERF_SOFTRESET_6358_REG; */
...
#define reset_reg 0x34 /* PERF_SOFTRESET_6358_REG */
#endif
...
{
	__bcm63xx_core_set_reset(mask, reset);
}
EXPORT_SYMBOL(bcm63xx_core_set_reset_raw);
...
arch_initcall(bcm63xx_reset_bits_init);
